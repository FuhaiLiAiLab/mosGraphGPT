...
class GraphFormerDecoder(nn.Module):
    def __init__(self, pretrain_input_dim, pretrain_output_dim, 
        ...
        self.conv_first, self.conv_block, self.conv_last = self.build_conv_layer(
                    pretrain_output_dim, input_dim, hidden_dim, embedding_dim)
        ...
        self.pretrain_transform = nn.Linear(pretrain_input_dim, pretrain_output_dim)
    ...
    def build_conv_layer(self, pretrain_output_dim, input_dim, hidden_dim, embedding_dim):
        conv_first = TransformerConv(in_channels=pretrain_output_dim+input_dim, out_channels=hidden_dim, heads=self.num_head)
