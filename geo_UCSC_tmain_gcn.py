...
def arg_parse():
    ...
    parser.add_argument('--train_result_path', nargs='?', dest='train_result_path', default='gcn', 
                        help='save path for model result. (default: gcn)')
...
def train_geogcn(args, fold_n, load_path, iteration_num, device, graph_output_folder, dataset, num_class):
    ...
    for i in range(1, epoch_num + 1):
        ...
        # fold_n = 1
        test_save_path = path
        test_acc, test_loss, tmp_test_input_df = test_geogcn(args, fold_n, model, test_save_path, device, graph_output_folder, i)
...
if __name__ == "__main__":
    ...
    train_geogcn(args, fold_n, load_path, start_iter_num, device, graph_output_folder, dataset, num_class)